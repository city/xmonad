...
main = do
    --xmproc <- spawnPipe "/usr/bin/xmobar /home/kizzo/.xmobarrc"
...
myKeys x = M.fromList $
    ...
    -- screenshot screen
    , ((modMask x, xK_Print), spawn "/home/kizzo/bin/screenshot scr")
    -- screenshot window or area
    , ((modMask x .|. shiftMask, xK_Print), spawn "/home/kizzo/bin/screenshot win")
...
--startup :: X ()
--startup = do
--spawn "feh --bg-scale /home/city/Pictures/matrix.jpg"
